<p align="center">
  <img src="assets/banner.svg" alt="Awesome Invoice Financing Platform Banner" width="100%" />
</p>
...
Curated open-source projects for self-hosting invoicing engines, web3 invoice tokenization, decentralized supply chain financing, and accounting foundations, sorted by GitHub star count (descending).

| Project | GitHub Star Badge | Core Architecture | Description |
| :--- | :--- | :--- | :--- |
...
| **Invoice Ninja** | [![Stars](https://img.shields.io/github/stars/invoiceninja/invoiceninja?style=social&color=white)](https://github.com/invoiceninja/invoiceninja/stargazers) | Laravel (PHP), Flutter | Self-hosted invoicing, payment gateway integration, quote generation, and recurring invoice management platform. |
| **IDURAR ERP CRM** | [![Stars](https://img.shields.io/github/stars/idurar/idurar-erp-crm?style=social&color=white)](https://github.com/idurar/idurar-erp-crm/stargazers) | Node.js, React, MongoDB | Modern ERP & CRM system tailored for managing sales invoices, payments, quotes, and customer accounts. |
| **Crater Invoice** | [![Stars](https://img.shields.io/github/stars/crater-invoice-inc/crater?style=social&color=white)](https://github.com/crater-invoice-inc/crater/stargazers) | PHP, Vue.js | Open-source invoice app designed for small businesses to track payments, create professional PDF invoices, and record expenses. |
| **Dolibarr ERP CRM** | [![Stars](https://img.shields.io/github/stars/Dolibarr/dolibarr?style=social&color=white)](https://github.com/Dolibarr/dolibarr/stargazers) | PHP, MySQL | Comprehensive business suite providing invoice management, supplier orders, inventory control, and trade finance record-keeping. |
| **Manta** | [![Stars](https://img.shields.io/github/stars/hql287/Manta?style=social&color=white)](https://github.com/hql287/Manta/stargazers) | Electron, React | Desktop invoicing application with customizable templates and local encrypted data storage for independent trade contractors. |
| **Kimai** | [![Stars](https://img.shields.io/github/stars/kimai/kimai?style=social&color=white)](https://github.com/kimai/kimai/stargazers) | Symfony (PHP), MySQL | Multi-user time tracking and invoice generation software for tracking billable hours and exportable financial statements. |
| **Frappe Books** | [![Stars](https://img.shields.io/github/stars/frappe/books?style=social&color=white)](https://github.com/frappe/books/stargazers) | Electron, Vue.js, Python | Free desktop accounting app for small businesses featuring double-entry ledger, sales invoices, and customer statements. |
| **GnuCash** | [![Stars](https://img.shields.io/github/stars/gnucash/gnucash?style=social&color=white)](https://github.com/gnucash/gnucash/stargazers) | C, C++, Scheme | Personal and small-business financial accounting software with invoice processing, receivables tracking, and tax reports. |
| **InvoicePlane** | [![Stars](https://img.shields.io/github/stars/InvoicePlane/InvoicePlane?style=social&color=white)](https://github.com/InvoicePlane/InvoicePlane/stargazers) | PHP, MySQL | Self-hosted invoicing system for managing quotes, client credit, payments, and custom invoice templates. |
| **SolidInvoice** | [![Stars](https://img.shields.io/github/stars/SolidInvoice/SolidInvoice?style=social&color=white)](https://github.com/SolidInvoice/SolidInvoice/stargazers) | Symfony (PHP) | Open-source invoicing application for small businesses and freelancers with REST API and automated payment collection. |
| **InvoFi (Stellar)** | [![Stars](https://img.shields.io/github/stars/Stellar-VaultLink/invofi?style=social&color=white)](https://github.com/Stellar-VaultLink/invofi/stargazers) | Rust, Soroban, Stellar | Decentralized invoice financing protocol on Stellar enable SMEs to tokenize invoices as real-world assets (RWA) for USDC liquidity pools. |
| **InvoX Platform** | [![Stars](https://img.shields.io/github/stars/kg290/invox-invoice-financing-platform?style=social&color=white)](https://github.com/kg290/invox-invoice-financing-platform/stargazers) | Solidity, React, Node.js | Blockchain-based invoice financing & factoring registry featuring AI-assisted risk negotiation, KYC verification, and dynamic credit scoring. |
| **SCF Thesis Contracts** | [![Stars](https://img.shields.io/github/stars/anadi2311/Thesis-Supply-Chain-Finance-and-Blockchain?style=social&color=white)](https://github.com/anadi2311/Thesis-Supply-Chain-Finance-and-Blockchain/stargazers) | Solidity, Hardhat | Smart contract framework supporting purchase order financing, invoice discounting, and reverse securitization pipelines. |
| **Supply Chain Finance (R01)** | [![Stars](https://img.shields.io/github/stars/reachoutlove01/Supply-Chain-Finance?style=social&color=white)](https://github.com/reachoutlove01/Supply-Chain-Finance/stargazers) | Ethereum, React, Plaid | ERC-721 invoice tokenization dapp featuring automated smart contract settlement and Plaid banking integration. |
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Invoice-Financing-Platform&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Invoice-Financing-Platform&type=date&legend=top-left)
